...
module.exports = {
	async up(queryInterface, Sequelize) {
		...
		},
		{
			...
			"product_desc": "Optimize play time with G102, a gaming mouse in a variety of cheerful colors. With LIGHTSYNC technology, a gaming-grade sensor, and a classic 6-button design, you'll brighten up your gaming and your desk. ",
		...
		},
		{
			...
			"product_desc": "LIGHTSPEED wireless gaming mouse is designed for serious performance with the latest technological innovations. Impressive 250 hour battery life. Now available in a variety of cheerful colors. ",
		...
		},
		{
			...
			"product_desc": "Four-switch D-pad for smooth control and a familiar console layout. Plug-and-play on PC. Windows® 11, Windows 10, Windows 8, Windows 7, or Windows Vista, ChromeOS™ Internet connection for optional software downloads",
		...
		},
		{
			...
			"product_desc": "D-pad four switches for accurate control. Fast 2.4 GHz wireless via USB nano receiver. Dual-motor vibration feedback. PC compatible. Windows® 11, Windows 10, Windows 8, Windows 7, or Windows Vista, ChromeOS™ Internet connection for optional software downloads",
		...
		},
		{
			...
			"product_desc": "The hard surface provides low friction and fast, smooth mouse movement. The rubber base stays in place for thrilling gaming. The surface texture is optimized for Logitech G mice and peak gaming performance.",
		...
		},
		{
			...
			"product_desc": "Large size, 400 x 460 mm, for more space and greater mouse movement. The rubber base stays in place for thrilling gaming. The surface texture is optimized for Logitech G mice and peak gaming performance.",
		...
		},
		{
			...
			"product_desc": "Full desktop gaming mouse pad with space to configure the setup to your liking. The surface texture is tuned for Logitech G mice. The rubber device stays in place so you can focus and control the game.",
		...
		},
		{
			...
			"product_desc": "Ergonomic Wireless MMO Gaming Mouse with 19 Programmable Buttons ",
		...
		{
			"id": 26,
			"product_name": "Razer Universal Quick Charging Stand for Xbox - Forza Horizon 5 Limited Edition",
			"product_desc": "This product features a race-inspired design that matches your Xbox controller. It offers a speedy refueling option with its quick charge capability and is universally compatible. The magnetic contact system enables easy one-handed navigation and ensures a secure connection. It's powered by a USB connection. Inside the package, you'll find a rechargeable battery, battery covers for both Xbox Series X|S and Xbox One, and a Type C to Type A cable.",
		...
		},
		{
			...
			"product_desc": "This mouse is crafted from hyper-durable materials and comes with mechanical switches that guarantee up to 60 million clicks. It's designed to be lightweight and ergonomic, ensuring comfort during use. The device boasts brilliant Prism lighting across three zones, displaying 16.8 million vivid colors. Its TrueMove Core optical gaming sensor ensures precise 1-to-1 tracking.",
		...
		},
		{
			...
			"product_desc": "The QCK L BLOODSPORT EDITION is a limited edition gaming mousepad inspired by the streetwise CS:GO skin. Crafted with the exclusive QcK micro-woven cloth, it offers superior control and is optimized for both low and high CPI movements. The mousepad is both durable and washable, ensuring longevity and easy maintenance. It measures 450 mm x 400 mm x 2 mm.",
		...
		},
		{
			...
			"product_desc": "The CORSAIR KATAR ELITE WIRELESS gaming mouse is lightweight at only 69g, offering impressive performance in a small size, making it perfect for those who prefer claw and fingertip grips.",
			"product_price": "1100000",
			"brand_id": 4,
			"category_id": 1
		},
		...
		},
		{
			...
			"product_desc": "ADVANCED GAMING SENSOR Equipped with an advanced gaming sensor, with up to 2,400 DPI that can be adjusted quickly. Make the right moves in any game situation. RGB ILLUMINATION With RGB Lighting, it will make your gaming time more vibrant as you light up your opponents. Anti-Slip Grip Special textured plastic anti-slip side grips keep the RhastaII G13 firmly in your hand and increase its durability.",
			"product_price": "89000",
			"brand_id": 5,
			"category_id": 1
		},
		...
		},
		{
			...
			"product_desc": "The Fantech Numeric Keyboard Office K801, also known as FTK801, is a wired numeric keypad specifically designed for office laptops or for those in need of a practical and compact additional NumPad.",
			"product_price": "49000",
			"brand_id": 5,
			"category_id": 2
		},
		{
			"id": 59,
			"product_name": "Fantech ATOM96 MK890 RGB Keyboard Gaming Mechanical Full Size",
			"product_desc": "The Fantech Numeric Keyboard Office K801, also known as FTK801, is a wired numeric keypad specifically designed for office laptops or for those in need of a practical and compact additional NumPad.",
		...
		{
			"id": 60,
			"product_name": "Fantech Gamepad Wireless Hall Effect NOVA WGP14",
			"product_desc": "The Fantech Numeric Keyboard Office K801, also known as FTK801, is a wired numeric keypad specifically designed for office laptops or for those in need of a practical and compact additional NumPad.",
			"product_price": "279000",
			"brand_id": 5,
			"category_id": 3
		...
		{
			"id": 66,
			"product_name": "Fantech ATO GEO Deskmat MP905 GE01 Mousepad XL",
			"product_desc": "Presenting the ATO GEO Series Desk Mat (MP905 GE01) – where impeccable design meets performance. The ATO GEO Series Desk Mat is not just about size, though its expansive 900 x 400 x 4mm dimensions ensure ample space for all your devices. It's about optimizing your experience. Whether you’re an avid gamer or a professional seeking precision, this mat caters to both speed and control. Its surface has been meticulously crafted to provide a balanced platform, allowing swift mouse movements while retaining enough resistance for precise control.",
			"product_price": "270000",
			"brand_id": 5,
			"category_id": 6
		},
		{
			"id": 67,
			"product_name": "Monitor AOC Gaming 24G2Z 24 inch IPS 1080 240Hz 0.5ms",
			"product_desc": "The AOC 24G2Z is a 23.8-inch Full HD gaming monitor with a rapid 0.5ms response time and 240Hz refresh rate. It boasts an IPS panel for wide viewing angles, supports multiple color gamuts for accurate color representation, and offers a dynamic contrast ratio of 80 million:1. Its ergonomic stand provides tilt, swivel, rotate, and height adjustments, and it's equipped with HDMI 2.0 and DisplayPort 1.2 ports for connectivity. Ideal for both gaming and professional tasks.",
