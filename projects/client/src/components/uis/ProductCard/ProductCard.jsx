...
const ProductCard = () => {
	return (
		<>
			<div className="product-card bg-background rounded-[20px] flex flex-col items-start border-1 border-neutral-200 hover:border-primary-500 dark:border-neutral-800 hover:dark:border-secondary-500 hover:shadow-md hover:shadow-primary-200 dark:hover:shadow-secondary-500 duration-200">
				<div className="image-wrapper aspect-square w-full h-full">
					<div className="image w-full h-full bg-primary-500 rounded-t-[20px]" />
				</div>
				<div className="product-content flex flex-col p-2 md:pt-2 md:px-4 md:pb-4">
